var SETTINGS = {
	imagesUrl: 'https://www.happyhey.com/new-tab/hudson-hornet-tab-list.txt',
	noScript: 'https://www.happyhey.com/share/hudson-hornet-tab/share.php?noscript=Yes',
	getUrl: 'https://www.happyhey.com/share/hudson-hornet-tab/getUrl.php',
	bannerUrl: 'https://www.happyhey.com/banner5/hudson-hornet-tab.php'
}
	...
	jQuery.ajax({
		...
		if(data.indexOf('happyhey.com') || data.indexOf('imgbox'))
		{
			...
			var share = new ShareButton({
				...
				title: "Do You Like Hudson Hornet?",
				description: "Get awesome Hudson Hornet HD images in each new Chrome tab!"
			});
			share.open();
		}
	})
